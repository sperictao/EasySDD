...
- **Interface 设计检查**：涉及 module interface / seam / adapter 时，按 `references/codebase-design.md` 补 module、interface facts、seam、depth / locality、dependency category 和 adapter 结论。
